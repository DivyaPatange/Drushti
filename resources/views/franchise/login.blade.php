...
<head>
    ...
    <title>Market Career Power | Franchise | Sign In</title>
    <!-- Favicon-->
...
<body class="login-page" style="background-color:#009688;">
    ...
    <div class="login-box">
        <div class="logo">
            ...
            <small>Franchise - Log In</small>
        </div>
        <div class="card">
            <div class="body text-center">
                <img src="{{ asset('asset/images/mcp123.png') }}" alt="" width="150px" class="">  
                <form id="sign_in" method="POST" action="{{ route('franchise.login.submit') }}">
                @csrf
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="{{ url('/franchise/register') }}">Register Now!</a>
                        </div>
