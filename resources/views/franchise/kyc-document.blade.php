...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form method="POST" action="{{ route('franchise.kyc-document.upload') }}" enctype="multipart/form-data">
                @csrf
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-12">
                        <input type="hidden" name="franchise_id" value="{{ $kycdetails->franchise_id }}">
