...
@section('page_title', 'Plan Payment')
@section('customcss')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="display:inline">3,000 /- Plan Payment List</h2>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="smallModalLabel">Plan Payment</h4>
            </div>
...
<script>
var SITEURL = "{{ route('franchise.plan-payment.index')}}";
...
$('body').on('click', '#submitButton', function () {
    ...
    { 
        $.ajax({
            type:"POST",
            url:"{{ route('franchise.plan-payment.store') }}",
