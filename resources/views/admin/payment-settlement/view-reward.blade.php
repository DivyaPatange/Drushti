...
@section('title', 'Reward Settlement List')
@section('page_title')
Reward Settlement List ({{ $settlement->month_year }})
@endsection
@section('customcss')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="margin-bottom:15px;">All Pending Reward Settlement List</h2>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="display:inline">All Paid Reward Settlement List</h2>
            </div>
            <div class="body">
                <div class="table-responsive">
...
<script>
var SITEURL = "{{ route('admin.reward-settlement.view', $settlement->id)}}";
...
var SITEURL1 = "{{ route('admin.reward-settlement.paid', $settlement->id)}}";
