...
@section('title', 'Income Settlement List')
@section('page_title')
Income Settlement List ({{ $settlement->month_year }})
@endsection
@section('customcss')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="margin-bottom:15px;">All Pending Income Settlement List</h2>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="display:inline">All Paid Income Settlement List</h2>
            </div>
            <div class="body">
                <div class="table-responsive">
...
<script>
var SITEURL = "{{ route('admin.income-settlement.view', $settlement->id)}}";
...
var SITEURL1 = "{{ route('admin.income-settlement.paid', $settlement->id)}}";
