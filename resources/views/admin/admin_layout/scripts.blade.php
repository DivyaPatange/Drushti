...
<script src="{{ asset('adminAsset/plugins/jquery-slimscroll/jquery.slimscroll.js') }}"></script>

<!-- Waves Effect Plugin Js -->
<script src="{{ asset('adminAsset/plugins/node-waves/waves.js') }}"></script>

<!-- Jquery CountTo Plugin Js -->
<script src="{{ asset('adminAsset/plugins/jquery-countto/jquery.countTo.js') }}"></script>

<!-- Morris Plugin Js -->
<script src="{{ asset('adminAsset/plugins/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('adminAsset/plugins/morrisjs/morris.js') }}"></script>
