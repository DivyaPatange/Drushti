...
@section('title', 'Distributor KYC Verification')
@section('page_title', 'Distributor KYC Verification')
@section('customcss')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2 style="display:inline"> Distributor KYC Verification List</h2>
            </div>
            <div class="body">
...
var SITEURL = "{{ route('admin.users.kyc-verification')}}";
...
$('body').on('click', '#status', function () {
    ...
    if(id){
        $.ajax({
            type: "get",
            url: "{{ url('admin/users/kyc-status') }}"+'/'+id,
