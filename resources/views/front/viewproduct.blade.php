    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
					...
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<!-- <ul class="slides">
								...
								<li data-thumb="asset/images/product/a1.png">
									<div class="thumb-image">
										<img src="asset/images/product/a1.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								
							</ul> -->
							<ul class="slides">
								<li data-thumb="{{ asset('asset/images/product/a1.png') }}">
									<div class="thumb-image">
										<img src="{{ asset('asset/images/product/a1.png') }}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="{{ asset('asset/images/product/a1.png') }}">
									<div class="thumb-image">
										<img src="{{ asset('asset/images/product/a1.png') }}" data-imagezoom="true" class="img-fluid" alt=""> </div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3">Detergent Combo Pack</h3>
					<p class="mb-3">
